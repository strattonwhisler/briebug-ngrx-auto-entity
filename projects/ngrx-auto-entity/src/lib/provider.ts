...
/** @internal */
export function _isAutoEntityFeature <FeatureKind extends NgRxAutoEntityFeatureKind>(value: any): value is NgRxAutoEntityFeature<FeatureKind> {
  return value && value.ɵkind != null && value.ɵproviders != null;
}

/** @internal */
export function _includesFeature <FeatureKind extends NgRxAutoEntityFeatureKind>(features: NgRxAutoEntityFeatures[], featureKind: FeatureKind): boolean {
...
export function provideAutoEntityStore(...features: NgRxAutoEntityFeatures[]): EnvironmentProviders {
  return makeEnvironmentProviders(
    _provideAutoEntityStore(features)
  );
}
...
export function withCustomStore(storeProvider: Type<Store> | InjectionToken<Store>): CustomStoreFeature {
  const providers = [
    { provide: NGRX_AUTO_ENTITY_APP_STORE, useExisting: storeProvider },
  ];
