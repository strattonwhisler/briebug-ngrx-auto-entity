...
/**
 * Sets up providers for the auto-entity service.
 *
 * @usageNotes
 *
 * ### Providing Auto-Entity Service
 *
 * Basic example of how you can the Auto-Entity Service with your entities:
 * ```
 ...
 * ```
 *
 * You can also provide the Auto-Entity Service configuration dynamically:
 * ```
 * bootstrapApplication(AppComponent, {
 *   providers: [
 *     provideAutoEntityService(() => {
 ...
 *
 * @publicApi
 * @param config An Auto-Entity Service configuration object or a factory function that returns an Auto-Entity Service configuration object.
